...
void main(void) {
    ...
    while(1){
        ...
        work(180, 135, 155, 149, 135, 155, 35);// servo 1 quay
        work(180, 155, 140, 180, 135, 155, 25);//servo 2 di xuong, servo3 di xuong
        delayms(5000);// dung 5s
        work(180, 135, 155, 180, 155, 140, 25);// servo2 di len, servo3 di len
        work(110, 135, 155, 180, 135, 155, 75);// servo1 quay
        work(110, 155, 140, 110, 135, 155, 25);// servo2 di xuong, servo3 ha xuong
        delayms(5000);// cho 5s
        work(149, 135, 155, 110, 155, 140, 40);// quay ve vi tri ban dau
        while(1);
    }
    return;
}
